...
public class Reserva2 extends javax.swing.JFrame {
    ...
    public Reserva2(int idvueloida,int idvuelovuelta,int idhotel,String asientosIda) {
        initComponents();
        this.setLocationRelativeTo(null);
        generar(idvuelovuelta);
        setResizable(false);
        this.idvueloida = idvueloida;
        this.idvuelovuelta = idvuelovuelta;
        this.idhotel = idhotel;
    ...
    private void btnregisvueloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnregisvueloActionPerformed
        String asientosVuelta= selectSeatsTxtArea.getText();
        Boleta boleta = new Boleta(idvueloida,idvuelovuelta,idhotel,asientosIda,asientosVuelta);
        boleta.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btnregisvueloActionPerformed

    
    public void generar(int idvuelovuelta){
        int c;
        int c1=0;
        int sum=0;
        //float price=0;
        ...
        ActionListener seatSelectionListener = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                showSelectedSeats(idvuelovuelta);
            }
        };
        ...
        for(int i=0;i<asiento.length;i++){
            ...
            boolean str = listaLineaAerea.get(idvuelovuelta).getAsientos().get(sum-1).isDisponibilidad();
            if (str==false) {
                tb.setEnabled(false);
            }
            panel.add(tb);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reserva2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Reserva2(0,4,0,"2").setVisible(true);
            }
        });
    }
